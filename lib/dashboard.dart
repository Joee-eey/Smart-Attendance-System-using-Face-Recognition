...
class _DashboardPageState extends State<DashboardPage> {
  final List<Folder> folders = [
    Folder('Class 1', DateTime(2025, 9, 1), files: [
      FileItem("Attendance List", DateTime(2025, 9, 20)),
      FileItem("Homework", DateTime(2025, 9, 22)),
    ]),
            ...
            TextField(
              decoration: InputDecoration(
                ...
                enabledBorder: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(8),
                    borderSide:
                        const BorderSide(color: Color(0x1A000000), width: 1)),
